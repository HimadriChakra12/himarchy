        ...
        <div layout="padding:2:1.5">
          ...
          <div layout="column gap:0.5">
            <panel-actions-button>
              <a
                href="${router.url(__vite_glob_0_25, { category: 'cookie-banner' })}"
              >
            ...
            <panel-actions-button>
              <a href="${router.url(__vite_glob_0_25, { category: 'ads-showing' })}">
            ...
            <panel-actions-button>
              <a href="${router.url(__vite_glob_0_25, { category: 'page-frozen' })}">
            ...
            <panel-actions-button>
              <a
                href="${router.url(__vite_glob_0_25, { category: 'layout-broken' })}"
              >
          ...
          <ui-text type="body-s" color="secondary" layout="margin:top:2">
            ...
            ${html`<ui-text type="label-s" underline
              ><a href="${router.url(__vite_glob_0_25)}">Other</a></ui-text
            >`}
