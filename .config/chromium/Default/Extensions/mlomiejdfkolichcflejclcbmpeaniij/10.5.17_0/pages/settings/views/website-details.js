...
import __vite_glob_0_22 from './tracker-details.js';
import __vite_glob_0_24 from './website-clear-cookies.js';
...
const __vite_glob_0_25 = {
  [router.connect]: {
    stack: () => [__vite_glob_0_22, __vite_glob_0_24],
    replace: true
  },
  domain: "",
        ...
        ${!isWebkit() && html`
          <div layout="row gap:5">
            ...
            <ui-button disabled="${clearedCookies}">
              <a href="${router.url(__vite_glob_0_24, { domain })}">
                Clear Cookies
              </a>
            </ui-button>
          </div>
