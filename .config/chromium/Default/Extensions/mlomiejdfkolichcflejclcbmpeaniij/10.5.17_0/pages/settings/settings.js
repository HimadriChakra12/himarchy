...
const Settings = {
  stack: router([__vite_glob_0_18, __vite_glob_0_27, __vite_glob_0_28, __vite_glob_0_17, __vite_glob_0_23], {
    transition: true,
  }),
  render: ({ stack }) =>
    html`
      <template layout="contents">
        <settings-layout data-qa="page:settings">
          ...
          <a
            ...
            class="${{
              active:
                router.active(__vite_glob_0_27, { stack: true }) &&
          ...
          <a
            ...
            class="${{ active: router.active(__vite_glob_0_28), wrap: true }}"
            slot="nav"
            translate="no"
