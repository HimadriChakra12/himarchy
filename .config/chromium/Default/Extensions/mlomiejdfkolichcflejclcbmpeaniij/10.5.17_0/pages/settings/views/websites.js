import Config, { ACTION_PAUSE_ASSISTANT, dismissAction } from '../../../store/config.js';
...
import __vite_glob_0_25 from './website-details.js';
import __vite_glob_0_26 from './websites-add.js';
...
const __vite_glob_0_27 = {
  [router.connect]: { stack: [__vite_glob_0_25, __vite_glob_0_26] },
  config: store(Config),
      ...
      <settings-page-layout layout="gap:4">
        ...
        <section layout="column gap:4" layout@768px="gap:5">
          <div layout="row items:center gap:2">
            ...
            <ui-button>
              <a href="${router.url(__vite_glob_0_26)}">Add</a>
            </ui-button>
          </div>
          ${websites.length
            ? html`
